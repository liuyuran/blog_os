...
本文会讲解如何在内核中实现分页技术。我们首先会探索一下能够让我们直接访问物理内存中页表所在页帧的特别技术，并分析它的优缺点，而后我们会实现能够进行地址转换和创建新页映射的函数。

<!-- more -->

这个系列的blog在[GitHub]上开放开发，如果你有任何问题，请在这里开一个issue来讨论。当然你也可以在[底部][at the bottom]留言。你可以在[`post-09`][post branch]找到这篇文章的完整源码。
